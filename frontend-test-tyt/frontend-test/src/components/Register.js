...
const Register = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    // Validating cedula
    if (!formData.cedula || !dniRegex.test(formData.cedula)) {
    ...
    console.log("pre", Object.keys(newErrors));
...
<label htmlFor="cedula" className="block text-sm font-medium leading-2 text-gray-900">
            Cédula
          </label>
          <div className="mt-2">
            <input
            ...
            /> 
            {errors.cedula && <p className="error-message m-0 p-0 text-red Bebas-Neue">{errors.cedula}</p>}
        ...
        <div>
          ...
          <div className="mt-2">
            <input
              ...
              className="block w-full rounded-md border-10 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            />
            {errors.email && <p className="error-message m-0 p-0 text-red Bebas-Neue">{errors.email}</p>}
          </div>
        </div>
        <div>
          ...
          <div className="mt-2">
            <input
              ...
              className="block w-full rounded-md border-10 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
            />
            {errors.phone && <p className="error-message m-0 p-0 text-red Bebas-Neue">{errors.phone}</p>}
          </div>
        </div>
    <div>
          <button
    ...
    {errors.non_field_errors && <p className="error-message m-0 p-0 text-white Bebas-Neue">{errors.non_field_errors}</p>}
